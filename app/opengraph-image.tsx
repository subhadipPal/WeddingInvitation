  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <img src={`data:image/png;base64,${bgBuf.toString('base64')}`} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={`data:image/png;base64,${bouquetBuf.toString('base64')}`} style={{ position: 'absolute', top: 36, left: 44, width: 72, height: 72, objectFit: 'contain' }} />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={`data:image/png;base64,${bouquetBuf.toString('base64')}`} style={{ position: 'absolute', top: 36, right: 44, width: 72, height: 72, objectFit: 'contain' }} />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={`data:image/png;base64,${bouquetBuf.toString('base64')}`} style={{ position: 'absolute', bottom: 36, left: 44, width: 72, height: 72, objectFit: 'contain' }} />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={`data:image/png;base64,${bouquetBuf.toString('base64')}`} style={{ position: 'absolute', bottom: 36, right: 44, width: 72, height: 72, objectFit: 'contain' }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0, zIndex: 10, padding: '0 80px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 20 }}>
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={`data:image/png;base64,${rosesBuf.toString('base64')}`} style={{ width: 36, height: 36, objectFit: 'contain' }} />
            <div style={{ width: 120, height: 1, background: 'rgba(201,168,76,0.6)' }} />
          </div>
